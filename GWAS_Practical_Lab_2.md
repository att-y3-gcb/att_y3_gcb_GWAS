...
All genotype information in these sessions are real, but for privacy purposes, the binary phenotype is simulated.
...
- [ ] **Lab Task 1: What are the effect size and p-value of the SNP?**
...
- [ ] **Lab Task 2: What is the new effect size and p-value of the SNP once ancestry/enviroment is taken into account?**
...
- [ ] **Lab Task 3: Perform a bonferonni adjust on our alpha value and create the bonf_alpha variable**
...
- [ ] **Lab Task 4: What is the mean and standard deviation of the PRS?**
...
- [ ] **Lab Task 5: What percentage of the overall phenotypic variation is being explained by the PRS model?**
...
- [ ] **Lab Task 6: What percentage of the overall phenotypic variation is being explained by the PRS model?**
